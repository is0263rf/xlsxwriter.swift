...
public struct Worksheet {
    ...
    public func write(formula: String, _ cell: Cell, format: Format? = nil) {
        let _ = worksheet_write_formula(
            lxwWorksheet, cell.row, cell.col, formula, format?.lxwFormat)
    }
    ...
    public func write(arrayFormula: String, range: Range, format: Format? = nil) {
        let _ = worksheet_write_array_formula(
            lxwWorksheet, range.row, range.col, range.row2, range.col2, arrayFormula,
            format?.lxwFormat)
    }
    ...
    public func write(unixtime: Int64, _ cell: Cell, format: Format? = nil) {
        let _ = worksheet_write_unixtime(
            lxwWorksheet, cell.row, cell.col, unixtime, format?.lxwFormat)
    }
    ...
    public func column(_ cols: Cols, pixels: UInt32, format: Format? = nil) {
        let _ = worksheet_set_column_pixels(
            lxwWorksheet, cols.col, cols.col, pixels, format?.lxwFormat)
    }
    ...
    public func table(
        ...
        _ = worksheet_add_table(
            ...
            &options)
        if name != nil { options.name.deallocate() }
